...
ALARM_PATH := vendor/47xperiencerom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/47xperiencerom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/47xperiencerom/prebuilt/common/media/audio/ringtones
