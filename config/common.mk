...
# Backup Tool
PRODUCT_COPY_FILES += \
    vendor/47xperiencerom/prebuilt/common/bin/backuptool.sh:install/bin/backuptool.sh \
    vendor/47xperiencerom/prebuilt/common/bin/backuptool.functions:install/bin/backuptool.functions \
    vendor/47xperiencerom/prebuilt/common/bin/50-lineage.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-lineage.sh

ifneq ($(strip $(AB_OTA_PARTITIONS) $(AB_OTA_POSTINSTALL_CONFIG)),)
PRODUCT_COPY_FILES += \
    vendor/47xperiencerom/prebuilt/common/bin/backuptool_ab.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.sh \
    vendor/47xperiencerom/prebuilt/common/bin/backuptool_ab.functions:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.functions \
    vendor/47xperiencerom/prebuilt/common/bin/backuptool_postinstall.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_postinstall.sh
...
PRODUCT_COPY_FILES += \
    vendor/47xperiencerom/config/permissions/backup.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/backup.xml

# Lineage-specific broadcast actions whitelist
PRODUCT_COPY_FILES += \
    vendor/47xperiencerom/config/permissions/lineage-sysconfig.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/lineage-sysconfig.xml

# Copy all Lineage-specific init rc files
$(foreach f,$(wildcard vendor/47xperiencerom/prebuilt/common/etc/init/*.rc),\
	$(eval PRODUCT_COPY_FILES += $(f):$(TARGET_COPY_OUT_SYSTEM)/etc/init/$(notdir $f)))

# Enable Android Beam on all targets
PRODUCT_COPY_FILES += \
    vendor/47xperiencerom/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/android.software.nfc.beam.xml
...
# This is Lineage!
PRODUCT_COPY_FILES += \
    vendor/47xperiencerom/config/permissions/org.lineageos.android.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/org.lineageos.android.xml
...
include vendor/47xperiencerom/config/aosp_audio.mk

# Include Lineage audio files
include vendor/47xperiencerom/config/lineage_audio.mk

ifneq ($(TARGET_DISABLE_LINEAGE_SDK), true)
# Lineage SDK
include vendor/47xperiencerom/config/lineage_sdk_common.mk
endif

# TWRP
ifeq ($(WITH_TWRP),true)
include vendor/47xperiencerom/config/twrp.mk
endif
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/47xperiencerom/overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/47xperiencerom/overlay/common
...
PRODUCT_EXTRA_RECOVERY_KEYS += \
    vendor/47xperiencerom/build/target/product/security/lineage

-include vendor/47xperiencerom-priv/keys/keys.mk
...
-include vendor/47xperiencerom/config/partner_gms.mk
