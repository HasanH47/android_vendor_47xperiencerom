...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp vendor/47xperiencerom/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	cat vendor/47xperiencerom/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
